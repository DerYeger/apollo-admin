...
export function requiredRule(i18n: VueI18n): Rule {
  return (v?: string) => (isDefined(v) && v.length > 0) || i18n.t('validations.required')
}

export function maxLengthRule(i18n: VueI18n, maxLength: number): Rule {
  return (v: string | null | undefined) => (isDefined(v) && v.length <= maxLength) || i18n.t('validations.too-long', [maxLength])
}
